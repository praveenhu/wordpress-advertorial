 ...
 */
// function advertorial_pagescroll() {
// 	wp_enqueue_style( 'page-scroll', get_template_directory_uri() . '/css/page-scroll.css' );
// }

// add_action( 'wp_enqueue_scripts', 'advertorial_pagescroll' );