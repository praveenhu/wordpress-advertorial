		...
		<div class="col-sm-12  header_title_container"> <!-- Contains the header and page title -->
			<a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'twentysixteen' ); ?></a>
				<header id="masthead" class="site-header" role="banner">
					<div class="site-header-main mar_top">
						<div class="site-branding col-sm-12 col-xs-5 content_center">
						...
						<button id="menu-toggle" class="menu-toggle col-xs-7"><?php _e( 'View Beard Supplies', 'twentysixteen' ); ?></button>
